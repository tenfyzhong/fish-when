...
@test "when -d $basetime250101 = 2025-01-01 08:00:00" (when -d $basetime250101) = "2025-01-01 08:00:00 CST"
@test "test TZ = Asia/Shanghai" "$TZ" = "Asia/Shanghai"

@test "when -d $basetimems250101 --ms = 2025-01-01 08:00:00" (when -d $basetimems250101 --ms) = "2025-01-01 08:00:00 CST"
@test "test TZ = Asia/Shanghai" "$TZ" = "Asia/Shanghai"
...
@test "when --tz US/Eastern -d $basetime250101 = 2024-12-31 19:00:00 EST" (when --tz US/Eastern -d $basetime250101) = "2024-12-31 19:00:00 EST"
@test "test TZ = Asia/Shanghai" "$TZ" = "Asia/Shanghai"

@test "when --tz US/Eastern -d 1746028800 = 2025-04-30 12:00:00 EDT" (when --tz US/Eastern -d 1746028800) = "2025-04-30 12:00:00 EDT"
@test "test TZ = Asia/Shanghai" "$TZ" = "Asia/Shanghai"
